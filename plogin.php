...
<center><div class="heading">President Login</div></center>
<div class="formdec">
...
$sql="SELECT ename,eid,description,fee,venuet,status FROM eventdetails WHERE status='1'";
...
echo '<li>'.$name.'&nbsp;&nbsp;'.'</li>';
echo "<input type=button value=Show-Details onclick= setVisibility('$i','inline')  />"."<input type=button value=Hide-Details onclick= setVisibility('$i','none')  />"."&nbsp;&nbsp;"."<form method=POST name=accept action=pconfirm.php >";
